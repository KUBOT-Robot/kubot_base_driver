...
void Data_holder::dump_params(struct Robot_parameter *params)
{
    ...
    ROS_INFO("[KUBOT]RobotParameters:\n \
                        ...
                        \t\t Sona_dis: %d mm\n \
                         ",
             model_name.c_str(), params->model_type, params->wheel_diameter, params->wheel_track, params->encoder_resolution / 4, params->motor_ratio, params->do_pid_interval, params->kp, params->ko, params->ki, params->ko, params->kd, params->ko, params->cmd_last_time, params->max_v_liner_x / 100., params->max_v_liner_y / 100., params->max_v_angular_z / 100., imu_name.c_str(), params->imu_type, params->sona_distance);
#endif
}
