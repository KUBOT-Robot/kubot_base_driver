...
void BaseDriver::update_robot_status()
{
	...
	raw_robot_status_msgs.sona5_dis = Data_holder::get()->sona_data[4];
	raw_robot_status_msgs.sona6_dis = Data_holder::get()->sona_data[5];
	raw_robot_status_msgs.sona7_dis = Data_holder::get()->sona_data[6];
	raw_robot_status_msgs.sona8_dis = Data_holder::get()->sona_data[7];
